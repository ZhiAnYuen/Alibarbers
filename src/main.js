...
console.log(list[0]);
document.getElementById("ownerName").innerText = list[0]["ownerName"];
document.getElementById("shopName").innerText = list[0]["shopName"];
document.getElementById("location").innerText = list[0]["location"];
console.log(list[0]["services"]);


// document.getElementById("list").innerText = list[0];
